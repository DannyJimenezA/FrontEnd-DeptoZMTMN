...
- Name: Registro de usuario >> Muestra error por formato de correo inválido
- Location: C:\Users\ivanh\OneDrive - Universidad Nacional de Costa Rica\4 año 1 ciclo\ing en sistemas 3\FrontEnd-DeptoZMTMN\tests\registro.spec.ts:21:3
...
Call log:
  - navigating to "http://localhost:5173/register", waiting until "load"
    ...
    at C:\Users\ivanh\OneDrive - Universidad Nacional de Costa Rica\4 año 1 ciclo\ing en sistemas 3\FrontEnd-DeptoZMTMN\tests\registro.spec.ts:22:16
```
